...
from keras.layers import Conv2D, Dense, Input, add, Activation, AveragePooling2D, GlobalAveragePooling2D, BatchNormalization
...
gpu_number         = 5
batch_size         = 32         # 64 or 32 or smaller
# epochs             = 250
epochs = 5        
iterations         = 782       
...
if __name__ == '__main__':
    ...
    # set optimizer
    sgd = tf.keras.optimizers.SGD(learning_rate=.1, momentum=0.9, nesterov=True)
    model.compile(loss='categorical_crossentropy', optimizer=sgd, metrics=['accuracy'])

    # set callback
    tb_cb     = TensorBoard(log_dir='/home/yby/DL-practice/tf-practice/densenet', histogram_freq=0)
