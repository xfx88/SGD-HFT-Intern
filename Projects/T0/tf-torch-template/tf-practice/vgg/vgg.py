...
dropout      = 0.5
weight_decay = 0.0001
log_filepath = '/home/yby/DL-practice/tf-practice/vgg'
...
# 这种方法不接受在constructor也就是__init__里面的输入
# change_lr = tf.keras.optimizers.schedules.LearningRateSchedule(scheduler)
