...
class Decoder(nn.Module):
    ...
    def __init__(self,
        ...
        self._selfAttention = MHA(d_model, q, v, h, attention_size, window_size, padding)
        self._encoderDecoderAttention = MHA(d_model, q, v, h, attention_size, window_size, padding)
