...
class ConvLstmNet(nn.Module):
    def __init__(self, in_features, seq_len, out_features):
        ...
        self.conv_1 = nn.Conv1d(in_channels=in_features,
                                ...
                                padding=(1,),
                                bias=False)
        self.conv_2 = nn.Conv1d(in_channels=64,
                                out_channels=128,
                                kernel_size=(3,),
                                padding=(1,),
                                bias=False)
        ...
        self.relu0 = nn.ReLU()
        self.rnn = nn.GRU(256, 32, num_layers=2, dropout = 0.5)
...
def train(local_rank, world_size, world_dict, shard_dict, validation = False, Resume = None):
    ...
    model_path = '/home/yby/SGD-HFT-Intern/Projects/T0/CNN/model/CNN/param_2/'
