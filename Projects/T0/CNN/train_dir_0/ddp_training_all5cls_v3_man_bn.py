...
os.environ["CUDA_VISIBLE_DEVICES"] = "0,1,3,5,7,9"
...
def train(local_rank, world_size, world_dict, shard_dict, validation = False, Resume = None):
    ...
    if local_rank == 0:
        tsboard_path = "/home/yby/SGD-HFT-Intern/Projects/T0/CNN/tensorboard_logs/cls5all_gelu_postnorm_v3_manu"
    ...
    net = ConvLstmNet(in_features=INPUT_SIZE,
                      ...
                      local_rank = local_rank).to(local_rank)
