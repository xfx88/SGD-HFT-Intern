...
class Predict:
    ...
    def specific_stock(self, stock_id, date):
        ...
        p_5_pred_prob, p_5_pred = label_extractor(p_5_pred, prob_up = 0.75, prob_down = 0.65)
        p_18_pred_prob, p_18_pred = label_extractor(p_18_pred, prob_up = 0.75, prob_down = 0.7)
