...
class Predict:
    ...
    def _load_model(self):
        model_path = '/home/yby/SGD-HFT-Intern/Projects/T0/CNN/train_dir_0/model/CNN_param_cls5all_matrix_v1/'
...
def specific_stock_batch(stock_ids, start_date, end_date):
    SAVING_PATH = '../prediction/grucnn_elu_v2/5cls_elu_ce_epoch79_cls5cls18_p5bound0.65/'
