...
class Predict:
    ...
    def _load_model(self):
        model_path = '/home/yby/SGD-HFT-Intern/Projects/T0/CNN/train_dir_0/model/CNN/param_clsall_matrix_v3_original/'
        model_name = 'CNNLstmCLS_epoch_12_bs10000_sl64_ts3.pth.tar'
    ...
    def specific_stock(self, stock_id, date):
        ...
        buy_close_condition = (res.fillPos > 0) & (res['predictions'].apply(lambda x: x[LABEL_IDX] == 1))
        sell_close_condition = (res.fillPos < 0) & (res['predictions'].apply(lambda x: x[LABEL_IDX] == 2))
...
def specific_stock_batch(stock_ids, start_date, end_date):
    SAVING_PATH = '../prediction/v2/cnn_clsall_ce_epoch11_cls5_p5bound0.7_common0_closep5/'
