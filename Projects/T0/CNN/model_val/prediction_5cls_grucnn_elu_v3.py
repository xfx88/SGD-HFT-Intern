...
class Predict:
    ...
    def _load_model(self):
        model_path = '/home/wuzhihan/Projects/CNN/train_dir_0/model/CNN_param_cls5all_matrix_relu_v3_manu'
        model_name = 'CNNLstmCLS_epoch_60_bs9600_sl64_ts3.pth.tar'
    ...
    def specific_stock(self, stock_id, date):
        ...
        p_5_pred_prob, p_5_pred = label_extractor(p_5_pred, prob_up=[0.6, 0.6], prob_down=[0.6, 0.6], cls_num=5)
        p_18_pred_prob, p_18_pred = label_extractor(p_18_pred, prob_up=[0.6, 0.6], prob_down=[0.6, 0.6], cls_num=5)
        ...
        pred_y = pd.concat([pred_y, data[['subcls_2', 'subcls_5', 'subcls_18', 'p_2', 'p_5', 'p_18']]], axis=1)
        ...
        buy_close_condition = (res.fillPos > 0) & ((
                                                       res['predictions'].apply(lambda x: any([i == 1 or i == 2 for i in x])))
                                                   )
