...
class Predict:
    ...
    def specific_stock(self, stock_id, date):
        ...
        p_2_pred = label_extractor(p_2_pred, prob_threshold=0.7).reshape((-1, 1))
        p_5_pred = label_extractor(p_5_pred, prob_threshold=0.7).reshape((-1, 1))
        p_18_pred = label_extractor(p_18_pred, prob_threshold=0.6).reshape((-1, 1))
...
def specific_stock_batch(stock_ids, start_date, end_date):
    SAVING_PATH = '../prediction/v2/CNN_param_v2_adam_clsall_focal/'
