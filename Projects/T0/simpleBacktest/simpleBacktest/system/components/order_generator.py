...
from simpleBacktest.system.trader.orders.general_order import (CancelPendingOrder,
                                                               CancelTSTOrder,
                                                               LimitBuyOrder,
                                                               LimitCoverOrder,
                                                               LimitSellOrder,
...
from simpleBacktest.system.trader.signals import (Signal, SignalByTrigger,
                                                  SignalCancelPending,
                                                  SignalCancelTST)


class OrderGenerator(EnvBase):
    counter = count(1)
